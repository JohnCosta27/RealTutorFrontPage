                  ...
                  <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="font-medium text-gray-200 hover:text-gray-900">
                        {item.name}
                      </a>
                    ))}
                    <a href="#" className="font-medium text-teal hover:text-indigo-500">
                      Log in
                    </a>
                  </div>
                </nav>
              ...
              <Transition
                ...
                <Popover.Panel
                  ...
                  <div className="rounded-lg shadow-md bg-gray-900 ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <a
                      href="#"
                      className="block w-full px-5 py-3 text-center font-medium text-teal bg-gray-50 hover:bg-gray-100">
                      Log in
                    </a>
                  </div>
                </Popover.Panel>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">A* Tutors</span>
                  <br />
                  <span className="block text-teal-500 xl:inline">For A* Students.</span>
                </h1>
